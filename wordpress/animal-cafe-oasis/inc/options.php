	...
	return array(
		'shop' => array(
			...
			'fields' => array(
				...
				'site_desc'   => array( 'label' => 'サイトの紹介文', 'type' => 'textarea',
				                        'default' => '爬虫類・鳥類・猛禽類・小動物・うさぎ・サル・犬・猫。飲食を楽しみながら動物たちと過ごせる、鹿児島県霧島市国分のあにまるカフェ Oasis。11:00–19:00／火曜定休／駐車場あり。',
				                        'desc' => 'LINEやInstagramにURLを貼ったときと、Google の検索結果に出る文章です。<br>80〜120文字くらいがちょうどよく、長いと途中で切れます。' ),
		...
		'hours' => array(
			...
			'fields' => array(
				...
				'price_note'  => array( 'label' => 'トップの料金の下に出す注意書き', 'type' => 'textarea',
				                        'default' => 'お食事のみ・生体のお買い上げのみの方は入場料は頂きません。ゾウガメの餌やり体験は1回200円。' ),
			),
		),
		'display' => array(
			'title'  => '表示の切り替え',
